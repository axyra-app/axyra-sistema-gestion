// ========================================
// CONFIGURACIÓN SEGURA DE FIREBASE AXYRA
// ========================================

// Configuración de Firebase para AXYRA - VERSIÓN SEGURA
const firebaseConfig = {
  // 🔑 API Key de Firebase - CONFIGURACIÓN REAL
  apiKey: process.env.FIREBASE_API_KEY || 'AIzaSyAW3ejokcsWAP5G1yJT63jLBpFmdTiTUwc',

  // 🌐 Dominio de autenticación
  authDomain: process.env.FIREBASE_AUTH_DOMAIN || 'axyra-48238.firebaseapp.com',

  // 📁 ID del proyecto
  projectId: process.env.FIREBASE_PROJECT_ID || 'axyra-48238',

  // 🗄️ Bucket de almacenamiento
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || 'axyra-48238.firebasestorage.app',

  // 📱 ID del remitente de mensajes
  messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || '796334517286',

  // 🆔 ID de la aplicación
  appId: process.env.FIREBASE_APP_ID || '1:796334517286:web:95947cf0f773dc11378ae7',

  // 📊 ID de medición (opcional)
  measurementId: process.env.FIREBASE_MEASUREMENT_ID || 'G-R8W2MP15B7',
};
  ...
  if (typeof firebase !== 'undefined') {
    try {
      ...
      window.axyraFirebase = {
        ...
        config: getSecureFirebaseConfig(),
