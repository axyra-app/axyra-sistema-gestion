...
class UnifiedHeader {
    ...
    createHeader() {
        ...
        this.header.className = 'unified-header';
    ...
    renderHeader() {
        ...
        const userPhoto = this.user && this.user.photoURL ? this.user.photoURL : 'https://via.placeholder.com/40x40/667eea/ffffff?text=U';
        ...
        this.header.innerHTML = `
          ...
          <div class="header-center">
            <div class="search-container">
              <input type="text" id="global-search" placeholder="Buscar..." class="search-input">
